...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (message === '') {
        ...
        setTimeout(() => {
            ...
            butttonIcon.classList.remove('fas', 'fa-spinner', 'fa-pulse');      // 사용자&봇의 메세지 전송이 끝나면 아이콘을 원래대로
        }, 1000);
        return
    }
    }
    ...
    butttonIcon.classList.add('fas', 'fa-spinner', 'fa-pulse');     // 사용자&봇이 메세지를 전송할 때에는 로딩 아이콘을 사용한다
